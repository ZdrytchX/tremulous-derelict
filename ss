commit 162edc7cd7930a0948c0fcd1841ea1d303ccf579
Author: ZdrytchX <ultrarandomvirus@hotmail.com>
Date:   Thu Dec 19 00:23:21 2013 -0800

    Now my TODO list is screwed up.

diff --git a/TODO_list-ZdrytchX b/TODO_list-ZdrytchX
new file mode 100644
index 0000000..f8e7951
--- /dev/null
+++ b/TODO_list-ZdrytchX
@@ -0,0 +1,88 @@
...
+*Game
+
+Add Teamkill/Free For All Mode XD
+
+*BGame
+
+[Done] Ramp Jumps
...
+
+
+***Ones that need Jeff's permission or help, or even just so he knows (just so he's happy)***
+*Game
+
...
+->Allow trappers to deal damage so we can have turrets shoot humans and trappers shoot aliens to prevent spawn camping (or we could use instagib maps, with only a rifle =[ )
+
+*BGame
+
...
+*BGame
+
+Challenge ProMode Physics toggle cvar (Missing quake's g_gamemode function)
+______________________________________
+
+***Ideas***
